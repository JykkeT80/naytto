...
foreach ($yritykset as $yritys) { ?>

<form action="" method="POST">
<input type="checkbox" name='yritys[]' value=<?php "$yritys[nimi]" ?>><?php echo "$yritys[nimi]"; ?><br>
<?php

}
?>
<input type="submit" value="Tulosta" name="tulosta">
</form>

<div class='tulosta'>
<?php
if (isset($_POST['tulosta'])){
    if(!empty($_POST['yritys'])) {
        foreach($_POST['yritys'] as $yritys){
